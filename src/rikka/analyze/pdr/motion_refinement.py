...
from .body_heading import estimate_dynamic_body_headings
from .heading import _classify_movement_type
from .models import StepHeading
from .motion_decoder import MotionDecodeResult, decode_step_motion_segments
from .sidestep import _smooth_step_headings, build_step_motion_observations
...
def _reproject_to_body_heading(
    ...
    movement = _classify_movement_type(
        forward,
        lateral,
        heading.yaw_delta,
