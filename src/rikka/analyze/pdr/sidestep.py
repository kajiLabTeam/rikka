...
heading.py が作った候補方位と体軸に対する変位から、横歩き・横歩き疑い・旋回を
軌跡用の移動状態へ整理する。単発の誤検出で軌跡が折れないよう、クラスタ単位で
横歩き evidence を確認し、採用する移動方位を安定化する。
"""
...
from .models import StepHeading, StepMotion
